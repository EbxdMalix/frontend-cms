            ...
            {filteredRequests.length === 0 ? (
              ...
              filteredRequests.map((request) => (
                <TableRow key={request._id}>
                  ...
                  <TableCell>
                    <span
                      className={`px-2.5 py-1 inline-flex text-xs leading-5 font-semibold rounded-full border shadow-xs ${getStatusBadge(
                        request.status
                      )}`}
                    >
                      {request.status}
                      ...
                      {request.status === "pending" && (
                        <>
                          <button
                            ...
                            className="text-green-500 hover:text-green-400 font-semibold cursor-pointer flex items-center gap-1"
                          >
                          ...
                          <button
                            ...
                            className="text-red-500 hover:text-red-400 font-semibold cursor-pointer flex items-center gap-1"
                          >
