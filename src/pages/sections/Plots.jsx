      ...
      <div className="bg-card border border-border rounded-lg p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            >
              ...
              {projects.map((project) => (
                <option key={project._id} value={project._id} className="bg-slate-900 text-slate-100">
          ...
          <div>
            ...
            >
              <option value="" className="bg-slate-900 text-slate-100">All Status</option>
              ...
              <option value="Sold" className="bg-slate-900 text-slate-100">Sold</option>
              <option value="Under Construction" className="bg-slate-900 text-slate-100">Under Construction</option>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Block/Phase</TableHead>
            ...
            {plots.length === 0 ? (
              ...
              plots.map((plot) => (
                <TableRow key={plot._id}>
                  ...
                  <TableCell>
                    <span
                      className={`px-2.5 py-1 rounded-full text-xs font-semibold border shadow-xs ${getStatusColor(
                        plot.status
                      )}`}
                    >
                      {plot.status}
